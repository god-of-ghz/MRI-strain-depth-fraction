...
%% VERSION HISTORY
% CREATED 5/8/19 BY SS
% MODIFIED 10/16/20 BY SS
%   - added safety for empty inputs
%   - added version history & organized code by section
...
if isempty(a)
    error('First argument (A) is empty!')
end
if isempty(b)
    error('Second argument (B) is empty!')
end
